       ...
       i++;
        ...
        if (Pattern.matches(emailPattern, emailInput) && Pattern.matches(passwordPattern, passwordInput)) {
         ...
         Statement st;
            ...
            // this entry the value from the user input accordingly in the databases
            String query = "INSERT INTO cms.student (full_name,Contact_no,address, emails, passwords, roles, courses) VALUES ('" + fullnames + "','" + contacts + "','" + addresses + "','" + emails + "','" + passwords + "','" + roles + "'," + courseValue + ")";
